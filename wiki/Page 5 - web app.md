...
Make sure you followed the previous steps of running the TCP server and Node Js server as required. <br>
Then, you can start exploring our app the URL : http://localhost:80 <br>
